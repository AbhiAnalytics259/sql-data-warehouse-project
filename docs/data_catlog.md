 ...
 **tables**  and  **fact tables**  for specific business metrics.
  ...
  **1.gold.dim_customers**
  ...
  - *columns:*
    ...
    |-----------|----------|------------|
    |customer_key | INT| Surrogate key unique identifying each customers record in the dimension table. |
...
--------------------------------------------------------------------------------------------------------------------------------------------------------------
  ...
  **2.gold.dim_products**
  ...
  - *columns:*
    ...
    |Column Name| Data Type| Description|
    |-----------|----------|------------|
    |product_key|INT | Surrogate key unique identifying each products record in the product dimension table. |
    ...
    |category | NVARCHAR(50) |The border classification of the product(e.g. Bikes, components) to group related items. |
    ...
    |product_line | NVARCHAR(50) | The specific product line or series to which the product belongs (e.g. Road, Mounatain). |
...
**3.gold.fact_sales**
  ...
  - *columns:*
    ...
    |Column Name| Data Type| Description|
    |-----------|----------|------------|
    |order_number| NAVRCHAR(50) | A unique alphanumeric identifier for each sales order (e.g 'SO54496'). |
    |product_key| INT | Surrogate key linking the order to the product dimension table. |
    |customer_key| INT | Surrogate key linking the order to the customer dimension table. 
    | order_date | DATE |The date when the order was place. |
